    ...
    def __init__(
        ...
        **kwargs,
        ...
        ec2_instance_front.add_user_data(
            ...
            "if ! command -v node >/dev/null 2>&1 || ! command -v npm >/dev/null 2>&1; then curl -fsSL https://rpm.nodesource.com/setup_22.x | sudo bash - && sudo yum install -y nodejs --allowerasing; fi",

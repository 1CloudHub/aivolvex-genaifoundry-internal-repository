    ...
    def __init__(
        ...
        **kwargs,
        ...
        ec2_instance.add_user_data(
            ...
            "printf 'git clone https://github.com/1CloudHub/aivolvex-genaifoundry-internal-repository.git || true\\n' >> /home/ec2-user/start_media_api.sh",
            "printf 'cd /home/ec2-user/aivolvex-genaifoundry-internal-repository/media_ec2_needs\\n' >> /home/ec2-user/start_media_api.sh",
            ...
            f'printf \'screen -dmS media_api bash -c "cd /home/ec2-user/aivolvex-genaifoundry-internal-repository/media_ec2_needs && source .venv/bin/activate && uvicorn {ec2_media_module}:app --host 0.0.0.0 --port 8000"\\n\' >> /home/ec2-user/start_media_api.sh',
        ...
        ec2_instance_front.add_user_data(
            ...
            "cd /home/ec2-user",
            "git clone https://github.com/1CloudHub/aivolvex-genaifoundry-internal-repository.git || true",
            "SRC_ZIP=$(find /home/ec2-user/aivolvex-genaifoundry-internal-repository -name 'src.zip' | head -1 || true)",
            "if [ -n \"$SRC_ZIP\" ]; then",
            ...
            "    cd \"$APP_DIR\"",
            "else",
            "    PKG_FILE=$(find /home/ec2-user/aivolvex-genaifoundry-internal-repository -name package.json 2>/dev/null | head -1 || true)",
